...
class EYSS_Admin_Settings
{
    ...
    {
        echo '<p>' . __('Configure your YouTube API settings. You can get an API key from the Google Developers Console.', 'embed-youtube-shorts') . '</p>';
    }
    ...
    {
        echo '<p>' . __('Configure how the YouTube Shorts will be displayed on your website.', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function api_key_callback()
    {
        ...
        echo '<button type="button" id="eyss-test-api" class="button button-secondary" style="margin-left: 10px;">' . __('Test Connection', 'embed-youtube-shorts') . '</button>';
        echo '<button type="button" id="eyss-debug-videos" class="button button-secondary" style="margin-left: 10px;">' . __('Debug Videos', 'embed-youtube-shorts') . '</button>';
        echo '<p class="description">' . __('Your YouTube Data API v3 key. <a href="https://developers.google.com/youtube/v3/getting-started" target="_blank">Get your API key here</a>.', 'embed-youtube-shorts') . '</p>';
    ...
    public function channel_id_callback()
    {
        ...
        echo '<p class="description">' . __('The YouTube Channel ID to fetch shorts from. Format: UCxxxxxxxxxxxxxxxxxxxxx', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function default_layout_callback()
    {
        ...
        echo '<option value="grid"' . selected($default_layout, 'grid', false) . '>' . __('Grid', 'embed-youtube-shorts') . '</option>';
        echo '<option value="carousel"' . selected($default_layout, 'carousel', false) . '>' . __('Carousel', 'embed-youtube-shorts') . '</option>';
        echo '<option value="list"' . selected($default_layout, 'list', false) . '>' . __('List', 'embed-youtube-shorts') . '</option>';
        echo '</select>';
        echo '<p class="description">' . __('The default layout for displaying YouTube Shorts.', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function videos_per_page_callback()
    {
        ...
        echo '<p class="description">' . __('Maximum number of videos to display per page (1-50).', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function max_short_duration_callback()
    {
        ...
        echo '<p class="description">' . __('Maximum duration (in seconds) for a video to be considered a Short. YouTube allows up to 3 minutes (180 seconds). Range: 60-600 seconds.', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function cache_duration_callback()
    {
        ...
        echo '<p class="description">' . __('How long to cache YouTube API responses (in seconds). Minimum 300 seconds (5 minutes).', 'embed-youtube-shorts') . '</p>';
    }
    ...
    public function scroll_type_callback()
    {
        ...
        echo '<label><input type="radio" name="eyss_settings[scroll_type]" value="load_more" ' . checked($scroll_type, 'load_more', false) . ' /> ' . __('Load More Button', 'embed-youtube-shorts') . '</label><br>';
        echo '<label><input type="radio" name="eyss_settings[scroll_type]" value="infinite_scroll" ' . checked($scroll_type, 'infinite_scroll', false) . ' /> ' . __('Infinite Scroll', 'embed-youtube-shorts') . '</label>';
        echo '<p class="description">' . __('Choose how additional videos are loaded: with a "Load More" button or automatically when scrolling to the bottom.', 'embed-youtube-shorts') . '</p>';
    }
...
?>
            ...
            <div id="eyss-settings-container">
                ...
                <div id="eyss-settings-sidebar">
                    <div class="eyss-sidebar-box">
                        <h3><?php _e('Shortcode Usage', 'embed-youtube-shorts'); ?></h3>
                        <p><?php _e('Use the following shortcode to display YouTube Shorts:', 'embed-youtube-shorts'); ?></p>
                        <code>[youtube_shorts]</code>

                        <h4><?php _e('Basic Parameters:', 'embed-youtube-shorts'); ?></h4>
                        <ul>
                        ...
                        <h4><?php _e('Playlist Filtering:', 'embed-youtube-shorts'); ?></h4>
                        <ul>
                        ...
                        <h4><?php _e('Basic Examples:', 'embed-youtube-shorts'); ?></h4>
                        ...
                        <h4><?php _e('Playlist Examples:', 'embed-youtube-shorts'); ?></h4>
                        ...
                        <h4><?php _e('Advanced Examples:', 'embed-youtube-shorts'); ?></h4>
                    ...
                    <div class="eyss-sidebar-box">
                        <h3><?php _e('Playlist Management', 'embed-youtube-shorts'); ?></h3>
                        <p><?php _e('Videos are automatically organized by their YouTube playlist membership when imported.', 'embed-youtube-shorts'); ?></p>

                        <h4><?php _e('Playlist Identifiers:', 'embed-youtube-shorts'); ?></h4>
                        <ul>
                        ...
                        <p><a href="<?php echo admin_url('edit-tags.php?taxonomy=youtube_playlist&post_type=youtube_short'); ?>" class="button button-secondary"><?php _e('Manage Playlists', 'embed-youtube-shorts'); ?></a></p>
                        <p><a href="<?php echo admin_url('edit.php?post_type=youtube_short'); ?>" class="button button-secondary"><?php _e('View Videos', 'embed-youtube-shorts'); ?></a></p>
                        <p><a href="<?php echo add_query_arg(array('page' => 'embed-youtube-shorts', 'playlist_test' => '1'), admin_url('options-general.php')); ?>" class="button button-secondary"><?php _e('Test Playlists', 'embed-youtube-shorts'); ?></a></p>
                    </div>

                    <div class="eyss-sidebar-box">
                        <h3><?php _e('Need Help?', 'embed-youtube-shorts'); ?></h3>
                        <p><?php _e('To get your YouTube API key:', 'embed-youtube-shorts'); ?></p>
                        <ol>
                            <li><?php _e('Visit the Google Developers Console', 'embed-youtube-shorts'); ?></li>
                            <li><?php _e('Create a new project or select existing', 'embed-youtube-shorts'); ?></li>
                            <li><?php _e('Enable the YouTube Data API v3', 'embed-youtube-shorts'); ?></li>
                            <li><?php _e('Create credentials (API key)', 'embed-youtube-shorts'); ?></li>
                        </ol>
                        <p><a href="https://developers.google.com/youtube/v3/getting-started" target="_blank" class="button button-primary"><?php _e('Get API Key', 'embed-youtube-shorts'); ?></a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {
        echo '<p>' . __('Import videos from YouTube channels to your WordPress database. This allows for unlimited results and better performance.', 'embed-youtube-shorts') . '</p>';
        echo '<p>' . __('You can import manually or set up automatic daily imports to keep your video library up-to-date.', 'embed-youtube-shorts') . '</p>';
    }
        ...
        <div id="eyss-import-container">
            ...
            <div class="eyss-import-controls">
                <button type="button" id="eyss-import-btn" class="button button-primary"
                    ...
                    <?php _e('Import All Videos', 'embed-youtube-shorts'); ?>
                </button>

                <button type="button" id="eyss-force-import-btn" class="button button-secondary"
                    <?php echo empty($channel_id) ? 'disabled' : ''; ?>>
                    <?php _e('Force Re-import', 'embed-youtube-shorts'); ?>
                </button>

                <a href="<?php echo admin_url('edit.php?post_type=youtube_short'); ?>" class="button">
                    <?php _e('Manage Videos', 'embed-youtube-shorts'); ?>
                </a>
            </div>

            <?php if (empty($channel_id)): ?>
                <p class="description" style="color: #d63638;">
                    <?php _e('Please configure your Channel ID above before importing videos.', 'embed-youtube-shorts'); ?>
                </p>
            <?php else: ?>
                <p class="description">
                    <?php 
            ...
            <div id="eyss-import-progress" style="display: none;">
                <h4><?php _e('Import Progress', 'embed-youtube-shorts'); ?></h4>
                ...
                <div id="eyss-progress-info">
                    <p id="eyss-progress-status"><?php _e('Starting import...', 'embed-youtube-shorts'); ?></p>
                    <p id="eyss-progress-details"></p>
                </div>
                <div id="eyss-progress-results" style="display: none;">
                    <h4><?php _e('Import Results', 'embed-youtube-shorts'); ?></h4>
    ...
    ?>
        <label>
            ...
            <?php _e('Enable automatic daily video import', 'embed-youtube-shorts'); ?>
        </label>
        <p class="description">
