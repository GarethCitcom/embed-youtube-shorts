...
$plugin_info = array(
    ...
    'upgrade_notice' => 'Major carousel enhancement with Splide.js library! Professional infinite loop carousel with center focus, plus comprehensive code cleanup.',
    'compatibility' => '6.8.3'
);
