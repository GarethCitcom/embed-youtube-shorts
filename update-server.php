...
if (strpos($request_uri, 'update-info.json') !== false) {
    ...
    $detailed_info = array(
        ...
        'upgrade_notice' => array(
            '2.3.1' => $plugin_info['upgrade_notice']
        )
    );
...
<body>
    ...
    <div class="changelog">
        ...
        <ul>
            <li><strong>Progress Bar Fix:</strong> Fixed video import progress bar animation that wasn't displaying real-time import progress</li>
            <li><strong>AJAX Reliability:</strong> Resolved duplicate AJAX handlers that prevented proper background import with progress tracking</li>
            <li><strong>Import Enhancement:</strong> Improved background import reliability with better error handling and retry logic</li>
            <li><strong>Cron Fallback:</strong> Added fallback import method for when WordPress cron is disabled or fails to schedule</li>
            <li><strong>UI Improvements:</strong> Progress bar now shows smooth CSS transitions during video import process</li>
        </ul>
    </div>
